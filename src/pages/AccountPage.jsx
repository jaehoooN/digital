...
export default function AccountPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen space-y-6 text-center p-6">
      <h1 className="text-3xl font-bold">{account.title}</h1>
      <a href={account.deeplink} className="px-6 py-3 text-xl bg-blue-600 text-white rounded hover:bg-blue-700">
        앱 접속
      </a>
